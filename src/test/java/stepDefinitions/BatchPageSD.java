...
public class BatchPageSD {
	...
	public void admin_should_see_the_title_in_batch_page(String string) {
		// Write code here that turns the phrase above into concrete actions
	...
	@Then("Admin should see the disabled {string} under the header in batch page")
	public void admin_should_see_the_disabled_under_the_header_in_batch_page(String string) {
		// Write code here that turns the phrase above into concrete actions
